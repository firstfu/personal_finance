...
// MARK: - Schema V3 (Sprout Growth Feature)

enum SchemaV3: VersionedSchema {
    static var versionIdentifier: Schema.Version = Schema.Version(3, 0, 0)

    static var models: [any PersistentModel.Type] {
        [Transaction.self, Category.self, Account.self, SproutPlant.self, HarvestRecord.self]
    }
}
...
enum FinanceMigrationPlan: SchemaMigrationPlan {
    ...
    // Lightweight migration: adds SproutPlant and HarvestRecord tables.
